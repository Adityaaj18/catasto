...
class InstallerController extends ConsoleController
{
    function index(){
        //$this->install();
    ...
    /*
        ...
        Es peligroso de momento oporque hace un "migrations fresh --force"
        y puede que la base de datos exista

        ... en cuyo caso deberia *preguntar* si se quiere sobre-escribir
        y luego pedir confirmacion (por el --force)
    */
    function install()
    {    
