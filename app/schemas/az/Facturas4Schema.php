...
{ 
	static function get(){
		return [
			...
			'required'		=> ['edad', 'firstname', 'username', 'password', 'texto_vb', 'texto', 'texto_tiny', 'texto_md', 'texto_long', 'codigo', 'blob_tiny', 'blob_md', 'blob_long', 'bb', 'json_str', 'code', 'big_num', 'ubig', 'medium', 'small', 'tiny', 'saldo', 'flotante', 'doble_p', 'num_real', 'some_bits', 'flavors', 'role', 'hora', 'birth_year', 'fecha', 'deleted_at', 'created_at', 'updated_at', 'correo', 'user_id'],
