...
{ 
	static function get(){
		return [
			...
			'nullable'		=> ['fac_intId', 'fac_decDescuento', 'fac_dateFecha', 'fac_bolEstado', 'fac_dtimFechaCreacion', 'fac_dtimFechaActualizacion', 'fac_varNota', 'fac_bolPagado'],
			...
			'rules' 		=> [
				...
				'fac_decDescuento' => ['type' => 'decimal(18,2)'],
